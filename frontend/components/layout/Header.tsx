                    ...
                    <div className="flex space-x-4 items-center mt-1">
                        {auth ?
                            <>
                                ...
                                <Link href="/dashboard"
                                      className="text-dark-accent hover:text-dark-shades transition-colors">
                            ...
                            : <>
                                <Link href="/register"
                                      className="bg-dark-accent text-light-shades hover:bg-dark-shades transition-colors rounded-lg border border-dark-accent px-2 pb-1">
                                    Sign Up
                                </Link>
